...
function setItem$2(key, value, callback) {
    ...
    var promise = new Promise$1(function(resolve, reject) {
        ...
        self
            ...
            .then(function() {
                dbInfo = self._dbInfo;
                if (toString$1.call(value) === '[object Blob]') {
...
const updateTaskStatus = async (prefix, taskName, status) => {
  if (status !== 'completed') {
...
export { MoleFetchClient, MoleFetchServiceWorker };
